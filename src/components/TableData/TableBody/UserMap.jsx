  ...
  return sortedArray.map((data, index) => {
    ...
    return (
      ...
      >
        ...
        <td className="capitalize tracking-wide py-8">{gender}</td>

        <td className="py-8">{age}</td>
        ...
        <td className="py-8">{fullAddress}</td>

        <td className="text-center py-8">{formattedDOB}</td>
      </tr>
    );
  });
}
